...
export default function ProductCard() {
  ...
  const cardsData = [
    {
      text: 'Thali',
      imageUrl: 'src/components/Photos/food-img1.png', // Thali ke liye placeholder
    },
    {
      text: 'Burger',
      imageUrl: 'src/components/Photos/food-img2.avif ', // Burger ke liye placeholder
    },
    {
      text: 'Veg Meal',
      imageUrl: 'src/components/Photos/food-img3.avif', // Veg Meal ke liye placeholder
    },
    {
      text: 'Biryani',
      imageUrl: 'src/components/Photos/food-img4.avif', // Biryani ke liye placeholder
    },
    {
      text: 'Cake',
      imageUrl: 'src/components/Photos/food-img5.avif', // Cake ke liye placeholder
    },
    {
      text: 'North Indian',
      imageUrl: 'src/components/Photos/food-img6.avif', // North Indian ke liye placeholder
    },
    {
      text: 'Pizza',
      imageUrl: 'src/components/Photos/food-img7.avif', // Ek aur card
    },
    {
      text: 'chiken',
      imageUrl: 'src/components/Photos/food-img8.avif', // Ek aur card
    },
  ];
      ...
      <div className="w-full max-w-6xl relative h-fit">
        ...
        >
          ...
          {cardsData.map((card, index) => (
            <div
              key={index}
              className="flex-shrink-0 p-2 flex flex-col items-center text-center h-fit"
